...
| 5 | Savings + Goals + Protection → pack | 7 | LOW-MED | TODO |
| 6 | Plans + Coordination → pack (depends on 3+4) | 7 | MED (BasePlanService extended by 4 pack services) | TODO |
| 7 | NetWorth → pack via core contract | 2+ | **HIGH** (3 core call-sites) | TODO |
| 8 | Agents: neutralise BaseAgent, move both agents, rebind, fix hard tests | 2+ | **HIGHEST** (7 pack extenders, binding, PackIsolationTest lines 676-685, 4 core call-sites) | TODO |
