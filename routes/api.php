...
Route::prefix('auth')->group(function () {
    ...
    // (auth-N, keyed by path|ip) so steps never throttle each other. The band
    // matches each route's previous inline limit. See the limiter definitions
    // and rationale in RouteServiceProvider::boot().
    ...
    Route::prefix('password-reset')->group(function () {
        ...
        Route::post('/reset', [PasswordResetController::class, 'reset'])->middleware('throttle:auth-3');
    });
