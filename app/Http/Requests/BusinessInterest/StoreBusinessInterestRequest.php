...
class StoreBusinessInterestRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'business_type' => ['nullable', Rule::in(['sole_trader', 'partnership', 'limited_company', 'llp', 'other'])],
    ...
    public function messages(): array
    {
        return [
            ...
            'current_valuation.required' => 'Please enter an estimated valuation.',
            'valuation_date.required' => 'Please enter the valuation date.',
        ];
    }
}
