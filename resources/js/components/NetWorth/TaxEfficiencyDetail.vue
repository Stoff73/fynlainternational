  ...
  <div class="detail-page">
    ...
    <div class="page-header">
      <button @click="goBack" class="detail-inline-back">
        ...
        Back to Investment Detail
      </button>
      <h1 class="page-title">Tax Efficiency</h1>
      <p class="page-subtitle">Analyse your portfolio's tax efficiency and optimisation opportunities</p>
    </div>
