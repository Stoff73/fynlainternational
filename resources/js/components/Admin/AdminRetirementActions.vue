<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h2 class="text-xl font-semibold text-horizon-500">Retirement Action Definitions</h2>
    ...
    <div v-else class="card p-12 text-center">
      <p class="text-neutral-500">No retirement action definitions found. Create one to get started.</p>
    </div>
