...
<head>
    ...
    <title>Spouse Invitation on Fynla</title>
    <style>
        ...
        <tr><td align="center" style="padding: 20px 0;">
            <table role="presentation" cellpadding="0" cellspacing="0" width="600" style="max-width: 600px; width: 100%; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 24px #d9d3cc;">
                ...
                <tr><td bgcolor="#1F2A44" style="background-color: #1F2A44; background-image: linear-gradient(135deg, #1F2A44, #e74c6f); padding: 28px 36px 0; min-height: 180px;">
                    <table role="presentation" cellpadding="0" cellspacing="0" width="100%"><tr>
                        <td style="padding-bottom: 28px; vertical-align: bottom;">
                            <h2 style="font-size: 36px; font-weight: 800; color: #ffffff; line-height: 1.15; margin: 0;">Spouse <span style="color: #f9a8c0;">invitation</span></h2>
                            <p style="font-size: 14px; color: #a8b0bf; margin: 6px 0 0 0;">Your approval is needed before anything is shared</p>
                        </td>
                ...
                <tr><td style="background: #f5f0eb; padding: 32px 36px;">
                    <p style="font-size: 20px; color: #1F2A44; font-weight: 700; margin: 0 0 10px 0;">Hi {{ $invitee->first_name ?? $invitee->name }},</p>
                    <p style="font-size: 14px; color: #555; line-height: 1.7; margin: 0 0 14px 0;">{{ $invitedBy->name }} has invited you to link your Fynla account with theirs as their spouse. Nothing has been linked yet — your approval is required before any data is shared.</p>

                    <div style="background: #fce4ec; border-radius: 10px; padding: 16px 20px; margin: 16px 0;">
                        <p style="font-size: 13px; margin: 0; color: #1F2A44;"><strong>What happens if you accept:</strong> Joint assets become visible on both dashboards. Each of you keeps your individual financial data (pensions, savings, protection) private. You can revoke this at any time from Settings.</p>
                    </div>

                    <p style="font-size: 14px; color: #555; line-height: 1.7; margin: 0;">If you weren't expecting this invitation, you can safely ignore this email — no link will be created.</p>
                </td></tr>

                {{-- CTA Block --}}
                <tr><td style="background: #fce4ec; padding: 28px 36px; text-align: center;">
                    <p style="color: #1F2A44; font-size: 16px; font-weight: 600; margin: 0 0 16px 0;">Review and respond to the invitation</p>
                    <a href="https://fynla.org/settings/spouse" style="display: inline-block; padding: 14px 40px; border-radius: 12px; font-size: 16px; font-weight: 700; background: #e74c6f; color: #ffffff; box-shadow: 0 4px 14px #d9a0b0;">Open Fynla</a>
                </td></tr>
