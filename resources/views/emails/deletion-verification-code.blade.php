        ...
        <tr><td align="center" style="padding: 20px 0;">
            <table role="presentation" cellpadding="0" cellspacing="0" width="600" style="max-width: 600px; width: 100%; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 24px #d9d3cc;">
                ...
                <tr><td style="background: #f5f0eb; padding: 32px 36px;">
                    ...
                    <p style="font-size: 14px; color: #555; line-height: 1.7; margin: 0 0 14px 0;">We received a request to permanently delete your Fynla account and all associated data. This includes:</p>

                    <ul style="font-size: 14px; color: #555; line-height: 2; padding-left: 20px; margin: 0 0 14px 0;">
                        <li>All financial data (accounts, pensions, investments, properties)</li>
                        <li>Goals, life events, and projections</li>
                        <li>Conversation history with Fyn</li>
                        <li>Your account and login credentials</li>
                    </ul>

                    {{-- Alert: Raspberry --}}
                    <div style="background: #e74c6f; border-radius: 10px; padding: 16px 20px; margin: 16px 0;">
                        <p style="font-size: 13px; margin: 0; color: #ffffff;"><strong>This action cannot be undone.</strong> Once confirmed, your data will be permanently deleted within 48 hours.</p>
                    </div>

                    <p style="font-size: 14px; color: #555; line-height: 1.7; margin: 0;">Enter the following code to confirm your deletion request. This code expires in 15 minutes.</p>
                    ...
                    <div style="background: #1F2A44; border-radius: 12px; padding: 24px; text-align: center; margin: 20px 0;">
                        ...
                        <div style="font-size: 12px; color: #8f97a8; margin-top: 8px;">Deletion verification code</div>
                    </div>
                </td></tr>

                {{-- Safety note: Eggshell --}}
                <tr><td style="background: #f5f0eb; padding: 0 36px 20px; text-align: center;">
                    <p style="font-size: 13px; color: #999; margin: 0;">If you didn't request this, please ignore this email or contact <a href="mailto:support@fynla.org" style="color: #e74c6f; text-decoration: none;">support@fynla.org</a> immediately.</p>
                </td></tr>
