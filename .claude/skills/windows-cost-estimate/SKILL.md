---
name: windows-cost-estimate
description: Estimate development cost of a codebase based on lines of code and complexity on Windows
---

# Cost Estimate Command (Windows)
...
- PHP programming: 10-20 lines/hour
- Frontend design and logic: 10-20 lines/hour
- Database design and implementation: 10-15 lines/hour
- System extensions/plugins: 8-12 lines/hour
- Logic, math, graphical abstraction and processing: 8-12 lines/hour
...
Run `git log --format="%ai" | Sort-Object` to get all commit timestamps. Then:
...
```powershell
Get-ChildItem -Recurse -Include "*.php","*.vue","*.js" | Sort-Object LastWriteTime | Select-Object LastWriteTime, FullName
```
...
Example: If a human would need 500 hours but Claude did it in 20 hours -> 25x faster
