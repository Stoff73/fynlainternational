...
import InvestmentPersonalInformation from '@gb/components/Plans/Investment/InvestmentPersonalInformation.vue';
import ProtectionCurrentSituation from '@gb/components/Plans/Protection/ProtectionCurrentSituation.vue';
import RetirementCurrentSituation from '@gb/components/Plans/Retirement/RetirementCurrentSituation.vue';
import EstateCurrentSituation from '@gb/components/Plans/Estate/EstateCurrentSituation.vue';
import PlanActionsList from '@gb/components/Plans/Shared/PlanActionsList.vue';
import PlanWhatIfComparison from '@gb/components/Plans/Shared/PlanWhatIfComparison.vue';
import ProtectionWhatIfControls from '@gb/components/Plans/Protection/ProtectionWhatIfControls.vue';
import InvestmentGroupedActions from '@gb/components/Plans/Investment/InvestmentGroupedActions.vue';
import RetirementGroupedActions from '@gb/components/Plans/Retirement/RetirementGroupedActions.vue';
import EstateGroupedActions from '@gb/components/Plans/Estate/EstateGroupedActions.vue';
