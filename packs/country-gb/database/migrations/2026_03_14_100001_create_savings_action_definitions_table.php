...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('savings_action_definitions')) {
            return;
        }

        Schema::create('savings_action_definitions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('savings_action_definitions');
    }
};
