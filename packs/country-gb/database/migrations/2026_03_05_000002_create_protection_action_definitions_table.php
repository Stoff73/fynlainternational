...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('protection_action_definitions')) {
            return;
        }

        Schema::create('protection_action_definitions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('protection_action_definitions');
    }
};
