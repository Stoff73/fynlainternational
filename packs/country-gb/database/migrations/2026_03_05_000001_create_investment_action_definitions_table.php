...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('investment_action_definitions')) {
            return;
        }

        Schema::create('investment_action_definitions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('investment_action_definitions');
    }
};
