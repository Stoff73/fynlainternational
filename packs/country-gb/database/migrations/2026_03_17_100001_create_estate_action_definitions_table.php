...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('estate_action_definitions')) {
            return;
        }

        Schema::create('estate_action_definitions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('estate_action_definitions');
    }
};
